...
|   |   |
|:--|-------:|
| TGP application period: | **TBD** |
| Evaluation: | **TBD** |
| Contact grant receivers: | **TBD** |
| Conference: | **27 July - 2 August 2026 (proposed)** |
...
The local organising committee plans to provide travel grants in cooperation with OSGeo.
...
The number and size of grants may be adjusted by the FOSS4GE
...
- Eligibility criteria will be published closer to the event.
...
be determined by the point ranking. In case of equal points, tie-breaking rules will be published closer to the event.
...
**Please note!** Receivers of travel grants need to arrange necessary visas and other documents needed to attend the conference.
