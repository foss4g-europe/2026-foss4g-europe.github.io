...
date: 2026-02-09T20:41:24+02:00
...
{{< faq "What is FOSS4G Europe?" >}}
FOSS4G Europe is the European conference of the global Free and Open Source Software for Geospatial (FOSS4G) series, organized under the umbrella of OSGeo. It brings together developers, users, researchers, companies, and public institutions working with open geospatial technologies.
{{</ faq >}}

{{< faq "When and where will the conference take place?" >}}
The conference is planned to take place from **29 June to 3 July 2026** in **Timișoara, Romania**.
{{</ faq >}}

{{< faq "If the conference is in Romania, does it mean my presentation/workshop needs to be in Romanian?" >}}
...
* Public authorities, NGOs, and companies
* Newcomers and non‑coders are very welcome
{{</ faq >}}
...
* **Workshops:** Hands-on sessions led by experts to enhance your skills.
* **Presentations:** Talks and lectures covering the latest advancements and applications.
* **Community Meetings:** Project meetings, Birds of a Feather (BoF) sessions, and community/code sprints.
* **Networking & Social Events:** Opportunities to connect through B2B events, GeoChicas, the Ice-Breaker, and the Gala Dinner.
{{</ faq >}}

{{< faq "Will the presentations be public after the conference?" >}}
Yes, all presentations are planned to be recorded and made publicly available. After the conference, the recorded talks will be published on:
{{< extlink href="https://video.osgeo.org/c/foss4geurope/videos" title="OSGeo PeerTube" >}},
{{< extlink href="https://av.tib.eu/publisher/FOSS4G" title="TIB-AV portal" >}}, and
...
{{< faq "Is there a Code of Conduct?" >}}
Yes. The event follows the **OSGeo Code of Conduct**, ensuring a respectful, inclusive, and welcoming environment for all participants. The official policy can be viewed here: [https://2026.europe.foss4g.org/about/coc/](https://2026.europe.foss4g.org/about/coc/)
{{</ faq >}}

{{< faq "Do I need a visa to attend the conference?" >}}
Whether you need a visa depends on your nationality. Please consult official resources for Romania to ensure you have up-to-date information. 
...
* [LinkedIn](https://www.linkedin.com/company/foss4g-europe)
* [Mastodon](https://mastodon.social/@foss4geurope@fosstodon.org)
* [Facebook](https://www.facebook.com/profile.php?id=61588025475556)
{{</ faq >}}
